...
The boxplot below summarizes the spread of average price for the two type of markets. OTC markets has lowest values of average price compared to Stock, however both seem to show the same spread. Stock market shows some possible outliers, which might indicate that some extra variation to the data.
